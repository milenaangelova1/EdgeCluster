...
class EdgeCluster:
    ...
    def fit(self, window:dict, initial_clustering:list):
        ...
        """
        matched, deviated, merges, windows, merge_window_with_cluster, merge_cluster_with_window = False, False, [], [], False, False
        ...
        if dist(cluster['mean'], window['mean']) > (dist(cluster['low'], cluster['mean']) + dist(window['mean'], window['high'])):
            ...
            if dist(cluster['low'], cluster['mean']) > dist(window['mean'], window['high']):
                ...
                merge_window_with_cluster = True
        ...
        return {
            ...
            "changes": {
                ...
                "merges": merges,
                "windows": windows,
                "merge_window_with_cluster": merge_window_with_cluster,
                "merge_cluster_with_window": merge_cluster_with_window
            },
            "window": window
        }